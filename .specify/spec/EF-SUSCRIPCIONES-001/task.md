...
* \[ \] **TASK-01: Migración de Tablas Principales**  
  * **Descripción:** Crear scripts de migración SQL para las tablas subscriptions y customer\_subscriptions con todas las constraints definidas en el Plan (checks de frecuencia, claves foráneas).  
  * **Archivos:** backend/src/database/migrations/00X\_create\_subscriptions.sql  
...
* \[ \] **TASK-02: Migración de Vistas Financieras (KPIs)**  
  * **Descripción:** Crear scripts SQL para las vistas mrr\_summary, arr\_summary, upcoming\_invoicing y expiring\_customer\_trials.  
  * **Archivos:** backend/src/database/migrations/00Y\_create\_subscription\_views.sql  
  * **Verificación:** Consultar vista vacía sin errores:  
    docker compose exec db psql \-U user \-d anclora \-c "SELECT \* FROM mrr\_summary LIMIT 1;"
